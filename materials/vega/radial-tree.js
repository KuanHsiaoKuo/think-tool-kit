...
target = 'language' + '-radial-tree'
selected_elements = document.getElementsByClassName(target)
if (selected_elements.length) {
    vegaEmbed(
        '.' + target,
        spec,
        {mode: "vega"}
    ).then(console.log).catch(console.warm);
} else {
    console.log('not found .' + target)
}
// vegaEmbed("#radial-tree", spec, {mode: "vega"}).then(console.log).catch(console.warn);